...
SOE^{\text{CEV,end}}_e,0)$, converted to hours by the day's \emph{required} weighted work-power rate
($\text{required kWh}/\text{required hours}$, from the full dig/load quota, not what was actually
achieved), and
