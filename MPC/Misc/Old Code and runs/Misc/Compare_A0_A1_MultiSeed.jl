# #############################################################################
# Compare_A0_A1_MultiMode.jl  —  A0 vs A1 across 4 modes x 20 seeds each
# -----------------------------------------------------------------------------
...
#
# Runs all 4 modes x 20 seeds = 80 total (A0, A1) pairs. Full detailed output
...
CONFIG_MODES           = [:live_data, :near_mean, :normal, :low]
CONFIG_N_SEEDS         = 20
CONFIG_MASTER_SEED     = 55          # same seeds get reused across all 4 modes
