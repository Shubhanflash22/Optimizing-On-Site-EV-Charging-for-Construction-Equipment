# #############################################################################
# RUN_ALL_25_RUNS.jl — consolidated sweep across all 5 modes.
#
...
# -----------------------------------------------------------------------------
const RESULTS_ROOT = normpath(joinpath(_THIS_DIR, "..", "Output_AllRuns"))
mkpath(RESULTS_ROOT)
const MANIFEST_PATH = joinpath(RESULTS_ROOT, "manifest_25runs.csv")
...
const RUNS = [
    ...
    (label = "01_GroundTruth_seed7_1200s",  mode = :live_data, seed = 7,  n_day_run = 1, time_limit_sec = 1200.0, detailed_output = true),
    (label = "02_GroundTruth_seed18_1200s", mode = :live_data, seed = 18, n_day_run = 1, time_limit_sec = 1200.0, detailed_output = true),
    (label = "03_GroundTruth_seed55_1200s", mode = :live_data, seed = 55, n_day_run = 1, time_limit_sec = 1200.0, detailed_output = true),

    (label = "04_High_seed7_1200s",         mode = :high,      seed = 7,  n_day_run = 1, time_limit_sec = 1200.0, detailed_output = true),
    (label = "05_High_seed18_1200s",        mode = :high,      seed = 18, n_day_run = 1, time_limit_sec = 1200.0, detailed_output = true),
    (label = "06_High_seed55_1200s",        mode = :high,      seed = 55, n_day_run = 1, time_limit_sec = 1200.0, detailed_output = true),

    (label = "07_Low_seed7_1200s",          mode = :low,       seed = 7,  n_day_run = 1, time_limit_sec = 1200.0, detailed_output = true),
    (label = "08_Low_seed18_1200s",         mode = :low,       seed = 18, n_day_run = 1, time_limit_sec = 1200.0, detailed_output = true),
    (label = "09_Low_seed55_1200s",         mode = :low,       seed = 55, n_day_run = 1, time_limit_sec = 1200.0, detailed_output = true),

    (label = "10_NearMean_seed7_1200s",     mode = :near_mean, seed = 7,  n_day_run = 1, time_limit_sec = 1200.0, detailed_output = true),
    (label = "11_NearMean_seed18_1200s",    mode = :near_mean, seed = 18, n_day_run = 1, time_limit_sec = 1200.0, detailed_output = true),
    (label = "12_NearMean_seed55_1200s",    mode = :near_mean, seed = 55, n_day_run = 1, time_limit_sec = 1200.0, detailed_output = true),

    (label = "13_Normal_seed7_1200s",       mode = :normal,    seed = 7,  n_day_run = 1, time_limit_sec = 1200.0, detailed_output = true),
    (label = "14_Normal_seed18_1200s",      mode = :normal,    seed = 18, n_day_run = 1, time_limit_sec = 1200.0, detailed_output = true),
    (label = "15_Normal_seed55_1200s",      mode = :normal,    seed = 55, n_day_run = 1, time_limit_sec = 1200.0, detailed_output = true),

    # ---- 5-day block, seed 7, 1200s (5 runs) ----
    (label = "16_GroundTruth_seed7_5days",  mode = :live_data, seed = 7, n_day_run = 5, time_limit_sec = 1200.0, detailed_output = true),
    (label = "17_High_seed7_5days",         mode = :high,      seed = 7, n_day_run = 5, time_limit_sec = 1200.0, detailed_output = true),
    (label = "18_Low_seed7_5days",          mode = :low,       seed = 7, n_day_run = 5, time_limit_sec = 1200.0, detailed_output = true),
    (label = "19_NearMean_seed7_5days",     mode = :near_mean, seed = 7, n_day_run = 5, time_limit_sec = 1200.0, detailed_output = true),
    (label = "20_Normal_seed7_5days",       mode = :normal,    seed = 7, n_day_run = 5, time_limit_sec = 1200.0, detailed_output = true),

    # ---- 1-hour (3600s) block, seed 7, 1 day (5 runs) ----
    (label = "21_GroundTruth_seed7_3600s",  mode = :live_data, seed = 7, n_day_run = 1, time_limit_sec = 3600.0, detailed_output = true),
    (label = "22_High_seed7_3600s",         mode = :high,      seed = 7, n_day_run = 1, time_limit_sec = 3600.0, detailed_output = true),
    (label = "23_Low_seed7_3600s",          mode = :low,       seed = 7, n_day_run = 1, time_limit_sec = 3600.0, detailed_output = true),
    (label = "24_NearMean_seed7_3600s",     mode = :near_mean, seed = 7, n_day_run = 1, time_limit_sec = 3600.0, detailed_output = true),
    (label = "25_Normal_seed7_3600s",       mode = :normal,    seed = 7, n_day_run = 1, time_limit_sec = 3600.0, detailed_output = true),
]
...
function main()
    ...
    println("="^78)
    println("25-RUN CONSOLIDATED SWEEP (GroundTruth / High / Low / NearMean / Normal)")
