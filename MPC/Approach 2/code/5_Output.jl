...
# the CEV(s) (DetailedPlanLog/RealizedTupleLog, with a scenario_id column) and
# the MCS (MCSPlanLog/MCSRealizedLog) -- see run_mpc's `detailed_output`
# kwarg. A no-op (writes nothing) if `res` was produced with
# detailed_output = false, since res.detailed_plan_df etc are `nothing` then.
# =============================================================================
