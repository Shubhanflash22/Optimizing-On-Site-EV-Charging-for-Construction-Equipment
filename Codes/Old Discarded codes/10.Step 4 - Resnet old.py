...
VIDEO_PATH  = Path(r"/mnt/nvme1/avik_shubhan/resnet3d/Day_2.mp4")
OUTPUT_DIR  = Path(r"/mnt/nvme1/avik_shubhan/resnet3d/")
...
# --- OLD CRASHING VERSION (COMMENTED OUT) ---
...
#     as Part 8's build_resample_map.
#     """
...
#         if not ret:
#             break
#         all_frames.append(frame)   # <--- THIS LINE KILLED YOUR RAM
#     cap.release()
#
