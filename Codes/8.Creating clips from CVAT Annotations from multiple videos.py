...
# VIDEO_PATH = r"/mnt/nvme1/avik_shubhan/resnet3d/Day_2.mp4"
# CVAT_XML   = r"/mnt/nvme1/avik_shubhan/resnet3d/annotations.xml"
# YOLO_MODEL = r"/mnt/nvme1/avik_shubhan/resnet3d/best.pt"
# OUTPUT_DIR = r"/mnt/nvme1/avik_shubhan/resnet3d/Dataset_Resnet_3"

VIDEO_XML_PAIRS = [
    (r"/mnt/nvme1/avik_shubhan/resnet3d/Day_2.mp4",   r"/mnt/nvme1/avik_shubhan/resnet3d/annotations_day2.xml"),
    (r"/mnt/nvme1/avik_shubhan/resnet3d/Day_3.mp4",   r"/mnt/nvme1/avik_shubhan/resnet3d/annotations_day3.xml"),
    (r"/mnt/nvme1/avik_shubhan/More_videos/Day_4_1.mp4",   r"/mnt/nvme1/avik_shubhan/More_videos/Day_4_1_annotations.xml"),
    (r"/mnt/nvme1/avik_shubhan/More_videos/Day_6_1.mp4",   r"/mnt/nvme1/avik_shubhan/More_videos/Day_6_1_annotations.xml"),
    (r"/mnt/nvme1/avik_shubhan/More_videos/Day_6_2.mp4",   r"/mnt/nvme1/avik_shubhan/More_videos/Day_6_2_annotations.xml"),
    (r"/mnt/nvme1/avik_shubhan/More_videos/Day_7_1.mp4",   r"/mnt/nvme1/avik_shubhan/More_videos/Day_7_1_annotations.xml"),
    (r"/mnt/nvme1/avik_shubhan/More_videos/Day_8_1.mp4",   r"/mnt/nvme1/avik_shubhan/More_videos/Day_8_1_annotations.xml"),
    (r"/mnt/nvme1/avik_shubhan/More_videos/Day_8_2.mp4",   r"/mnt/nvme1/avik_shubhan/More_videos/Day_8_2_annotations.xml"),
    (r"/mnt/nvme1/avik_shubhan/More_videos/Day_8_3.mp4",   r"/mnt/nvme1/avik_shubhan/More_videos/Day_8_3_annotations.xml"),
    (r"/mnt/nvme1/avik_shubhan/More_videos/Day_10_1.mp4",  r"/mnt/nvme1/avik_shubhan/More_videos/Day_10_1_annotations.xml"),
    (r"/mnt/nvme1/avik_shubhan/More_videos/Day_11_1.mp4",  r"/mnt/nvme1/avik_shubhan/More_videos/Day_11_1_annotations.xml"),
    (r"/mnt/nvme1/avik_shubhan/More_videos/Day_11_2.mp4",  r"/mnt/nvme1/avik_shubhan/More_videos/Day_11_2_annotations.xml"),
]
YOLO_MODEL = r"/mnt/nvme1/avik_shubhan/resnet3d/best.pt"
OUTPUT_DIR = r"/mnt/nvme1/avik_shubhan/resnet3d/Dataset_Resnet_3"
...
def extract_clips_with_yolo(video_path, yolo_model_path, frame_labels, output_dir,
                            ...
                            min_confidence=0.5, crop_size=112, start_indices=None):
    """
    ...
    clip_counter = dict(start_indices) if start_indices else {}
...
if __name__ == "__main__":
    ...
    global_clip_counter = {}   # tracks running clip counts across all videos

    for video_idx, (VIDEO_PATH, CVAT_XML) in enumerate(VIDEO_XML_PAIRS):
        print(f"\n{'=' * 50}")
        print(f"Processing video {video_idx + 1}/{len(VIDEO_XML_PAIRS)}: {VIDEO_PATH}")
        print(f"{'=' * 50}")

        print("\nStep 1: Parsing CVAT annotations...")
        frame_labels = parse_cvat_xml(CVAT_XML)
        if not frame_labels:
            print("WARNING: No labels found — skipping this video.")
            continue
        ...
        clip_stats = extract_clips_with_yolo(
            ...
            crop_size      = CROP_SIZE,
            start_indices  = global_clip_counter   # pass running counters in
        )

        global_clip_counter = clip_stats   # update with the new totals

    print("\n" + "=" * 50)
    total = sum(global_clip_counter.values())
    if total == 0:
        print("WARNING: No clips created across any video.")
    else:
        print(f"ALL VIDEOS DONE — {total} total clips across all activities")
        for act, count in sorted(global_clip_counter.items()):
            print(f"  {act}: {count} clips")
        print("Dataset ready for Part 9 training")
    print("=" * 50)