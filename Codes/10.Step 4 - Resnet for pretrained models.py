...
# ============================
SAVE_DIR = r"C:\Users\shubh\Desktop\New folder\Tubes"
METADATA_PATH = os.path.join(SAVE_DIR, "track_metadata.csv")
ACTIVITY_OUTPUT_CSV = r"C:\Users\shubh\Desktop\New folder\Activity_Output_1_50.csv"
ACTIVITY_VISUAL_CSV = r"C:\Users\shubh\Desktop\New folder\Activity_Visual_1_50.csv"
MODEL_PATH = r"C:\Users\shubh\Desktop\New folder\resnet3d_best_mc3_18.pth"

FPS = 59           # frames per second of video
CLIP_LENGTH = 32   # frames per clip for the 3D model
CROP_SIZE = 160    # model input spatial size (H=W=112)
STRIDE = 4        # clip stride (frames). Consider lowering to 4 for overlap.
VOTING_SECONDS = 2.0
...
def resnet3d_50(num_classes=NUM_CLASSES):
...
#model = resnet3d_18(num_classes=len(ACTIVITY_NAMES))
#model = resnet3d_50(num_classes=len(ACTIVITY_NAMES))
model = mc3_18(pretrained=False)  # pretrained=False because you load your checkpoint
in_features = model.fc.in_features
model.fc = nn.Linear(in_features, NUM_CLASSES)  # make sure NUM_CLASSES matches your training
