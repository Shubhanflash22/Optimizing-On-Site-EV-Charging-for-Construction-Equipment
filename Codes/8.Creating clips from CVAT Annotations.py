...
CVAT_XML = r"C:\Users\shubh\Desktop\Research_work_with_AVIK\Test\Dataset\Labelled Dataset Day 1\annotations.xml"
YOLO_MODEL = r"C:\Users\shubh\Desktop\Research_work_with_AVIK\Test\yolo_excavator_custom\weights\best.pt"
OUTPUT_DIR = r"C:\Users\shubh\Desktop\Research_work_with_AVIK\Test\Dataset"
...
def parse_cvat_xml(xml_path):
    """
    Parse CVAT XML with <image> -> <box> structure.
    ...
    for image in root.findall(".//image"):
        frame_num = int(image.get("id"))  # or extract from name if needed
        for box in image.findall("box"):
            label = box.get("label")
            frame_labels[frame_num] = label  # if multiple boxes per frame, this will overwrite
...
def extract_clips_with_yolo(video_path, yolo_model_path, frame_labels, output_dir, 
                            clip_length=16, stride=8, min_confidence=0.5, crop_size=112):
    """
