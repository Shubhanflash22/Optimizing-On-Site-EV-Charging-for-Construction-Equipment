...
VIDEO_PATH = Path(r"/mnt/nvme_data/Avik_Shubhan_codes_data/Day_2.mp4")  # UPDATE THIS
...
def apply_majority_voting(predictions, window_size=50):
    """
...
def main(video_path, model_path, output_dir, 
         majority_voting_window=50, bucket_payload=1.5):
    """
...
if __name__ == "__main__":
    ...
    if not VIDEO_PATH.exists():
        ...
        predictions, cycles, productivity = main(
            ...
            majority_voting_window=50,  # 1 second at 25 FPS
