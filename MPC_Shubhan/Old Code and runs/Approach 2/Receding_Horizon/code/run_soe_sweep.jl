...
for (idx, soe) in enumerate(soe_vals)
    ...
    row = _with_console_log(dst) do
        ...
        res = run_mpc(d, pool; plant = :sampled, n_days = N_DAYS, n_scenarios = N_SCENARIOS, time_limit_sec = Inf, seed = 1)
...
println(io, "<p class=\"muted\" style=\"margin-top:20px\"><b>Column notes.</b> ",
            ...
            "plans drifting under the stochastic pool); <b>&Delta; A2&minus;A0</b> = Realised &minus; ",
